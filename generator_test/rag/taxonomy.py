...
_NOTION_PATTERNS = {
    ...
    "expressions_littérales": [
        (3, [r'expression.*litterale', r'expression.*littérale',
             r'manipulation.*expression', r'manipulation d.expression',
             r'identite remarquable', r'identité remarquable',
             r'double distributivite', r'double distributivité',
             r'developper', r'développer',
             r'\(a\+b\)', r'a\^2.*b\^2',
             r'exprimer.*sachant que', r'isoler.*sachant que',  # format spécifique
             r'simplifier.*sachant que']),
        (2, [r'distributivite', r'distributivité', r'developp',
             r'factoris.*expression', r'litterale', r'littérale']),
        (1, [r'simplifier.*expression', r'calculer.*lettre', r'exprimer']),
    ],
    "polynômes_factorisation": [
